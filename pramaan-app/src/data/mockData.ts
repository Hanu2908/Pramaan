...
export const MOCK_NEWS: NewsItem[] = [
  ...
  {
    id: '2',
    headline: "FACT CHECK: Ministry of Education is NOT distributing free laptops to all college students",
    summary: "Alt News and PIB Fact Check confirm viral WhatsApp message claiming a free laptop scheme is FALSE. No official scheme exists under this name, link is a phishing site.",
    confidence: 'refuted', lane: 'verified', topic: 'government',
    sources: ['Alt News', 'PIB RSS'],
...
export const MOCK_CHECK: CheckResult = {
  ...
  summary: "Based on retrieved evidence, ACLED records two conflict-adjacent events near Churachandpur on 26 July 2026. However, no independent corroboration has been received from PIB or Alt News at this time. This claim is labeled 'Developing' — the highest 'Confirmed' tier requires agreement between at least two independent sources.",
  evidence: [
    { source: 'ACLED', snippet: 'Armed clash between state forces and non-state armed group, Churachandpur district, 26 Jul 2026.' },
    { source: 'Alt News', snippet: 'Monitoring social media claims about Manipur clashes. No fact-check article published as of 27 Jul 00:30 IST.' },
  ],
  isFallback: false,
...
export const PIPELINE_STAGES = [
  ...
  { id: 5, label: 'Confidence Scoring',    tool: 'Logic Engine',                     desc: 'Combines source agreement, similarity, authority, and refutation status into a tier.' },
...
export const SOURCES_META = [
  ...
  { name: 'Factly' as SourceName,          cadence: 'Daily',      role: 'Independent fact-checking & public data', color: 'var(--src-altnews)', note: 'Independent verification source.' },
  ...
  { name: 'Reality Defender' as SourceName,cadence: 'On-demand',  role: 'Deepfake / synthetic media detection', color: 'var(--src-reality)',   note: 'Free tier: 50 req/month. Image + audio only.' },
